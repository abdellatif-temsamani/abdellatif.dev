...
export default function Card({ cardInfo }: Readonly<CardProps>) {
    return (
        <div className="flex flex-col flex-grow gap-4 justify-evenly py-4 px-8 border-2 transition-colors duration-500 lg:w-96 group shadow-card hover:bg-sky-900">
